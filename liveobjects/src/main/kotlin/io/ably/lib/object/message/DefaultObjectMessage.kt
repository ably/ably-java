...
import io.ably.lib.`object`.WireCounterCreate
import io.ably.lib.`object`.WireCounterInc
import io.ably.lib.`object`.WireMapCreate
...
import io.ably.lib.`object`.WireObjectsMapEntry
import io.ably.lib.`object`.WireObjectsMapSemantics
...
internal class DefaultObjectData(private val data: WireObjectData) : ObjectData {
  ...
  override fun getBytes(): ByteArray? = data.decodedBytes()
