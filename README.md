...
A Java Realtime and REST client library for [Ably Realtime](https://www.ably.io), the realtime messaging and data delivery service. [View the features supported by our client library SDKs](https://www.ably.io/download/sdk-feature-support-matrix).
