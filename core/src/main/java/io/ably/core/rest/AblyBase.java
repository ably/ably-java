...
import io.ably.core.types.PublishResponse;
import io.ably.core.types.Stats;
import io.ably.core.types.StatsReader;
import io.ably.core.util.Crypto;
import io.ably.core.util.InternalMap;
...
public abstract class AblyBase<
     ...
     * @param method the HTTP method to use (see constants in io.ably.core.httpCore.HttpCore)
