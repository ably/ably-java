...
import io.ably.core.types.ChannelMode;
import io.ably.core.types.ChannelOptions;
import io.ably.core.types.ChannelProperties;
import io.ably.core.types.DecodingContext;
import io.ably.core.types.DeltaExtras;
import io.ably.core.types.ErrorInfo;
import io.ably.core.types.Message;
import io.ably.core.types.MessageDecodeException;
...
import io.ably.core.types.ProtocolMessage.Action;
import io.ably.core.types.ProtocolMessage.Flag;
import io.ably.core.util.CollectionUtils;
import io.ably.core.util.EventEmitter;
...
public abstract class RealtimeChannelBase extends EventEmitter<ChannelEvent, ChannelStateListener> implements AblyChannel {
    ...
    private static class MessageMulticaster extends io.ably.core.util.Multicaster<MessageListener> implements MessageListener {
        @Override
