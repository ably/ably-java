...
public class RealtimePresenceTest {
	...
	private PresenceMessage contains(PresenceMessage[] messages, String clientId, Action action) {
		for(PresenceMessage message : messages)
	...
	public void realtime_presence_unsubscribe_all() throws AblyException {
		...
		try {
			 ...
			 */
			PresenceWaiter leavePresenceWaiter = new PresenceWaiter(channel2);
	...
	public void realtime_presence_subscribe_multiple() throws AblyException {
		...
		EnumSet<Action> actions = EnumSet.of(Action.update, Action.leave);
	...
	public void realtime_presence_subscribe_single() throws AblyException {
		...
		try {
			 ...
			 * is emitted from emitter client (ably1)
			 */
			new PresenceWaiter(channel2).waitFor(ably1.options.clientId, Action.leave);
